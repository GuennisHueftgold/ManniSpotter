...
public class ShadowSnackbar {
    ...
    public static int getLatestSnackbarDuration() {
        if (!shadowSnackbars.isEmpty())
            return shadowSnackbars.get(shadowSnackbars.size() - 1).duration;
        return -1;
    }

    public void setAction(int resId, View.OnClickListener onClickListener) {
        //snackbar.setAction(resId,onClickListener);
        actionResId = resId;
